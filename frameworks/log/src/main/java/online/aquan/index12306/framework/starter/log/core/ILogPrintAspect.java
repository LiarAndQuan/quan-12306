...
package online.aquan.index12306.framework.starter.log.core;
...
public class ILogPrintAspect {
     ...
     * 打印类或方法上的 {@link ILog}
     */
    @Around("@within(online.aquan.index12306.framework.starter.log.annotation.ILog) || @annotation(online.aquan.index12306.framework.starter.log.annotation.ILog)")
